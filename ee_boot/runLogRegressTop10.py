...
print "OBSERVED DATA"
os.runObs(data, windowSizes1, windowSizes2, outfolder, rankFilter = 90, preprocess = preprocess, processX = processX)
#execfile("sup_ee_boot_varxy.py")

print "BOOTSTRAP"
bootrec = bs.runBoot(data, 20, windowSizes1, windowSizes2, rankFilter = 90, preprocess = preprocess, processX = processX)
